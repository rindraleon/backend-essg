...
const FIELD_LABELS: Record<string, string> = {
  ...
  bacSerie: 'série du baccalauréat',
  bacCategorie: 'catégorie du baccalauréat',
  numeroBaccalaureat: "numéro d'inscription au baccalauréat",
  bacAnneeObtention: "année d'obtention du baccalauréat",
  bacCentreExamen: "centre d'examen du baccalauréat",
  numeroBordereau: 'numéro de bordereau de versement',
  ancienEtablissement: 'ancien établissement',
  numeroMatricule: 'numéro matricule',
  licenceEtablissement: 'établissement de la Licence',
  licenceMention: 'mention de la Licence',
  licenceAnneeObtention: "année d'obtention de la Licence",
  titre: 'titre',
  slug: 'slug',
