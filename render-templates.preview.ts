...
<section><h2>1. Welcome (nouvel utilisateur back-office)</h2>${renderWelcomeTemplate({
  nom: 'Doe',
  prenom: 'John',
  email: 'john.doe@essg.sn',
  motDePasse: 'MotDePasse@2026',
  siteUrl: '',
})}</section>
<section><h2>2. Accusé de réception candidature</h2>${renderAdmissionConfirmationTemplate({ nom: 'RAKOTO', prenom: 'Hery', formation: 'Géomatique et Agriculture durable', reference: 'ESSG-42', niveau: 'Licence', mention: 'Géomatique et Applications', parcours: 'Géomatique et Agriculture durable', bacCategorie: 'scientifique', date: '19/08/2026', siteUrl: 'https://essg.mg' })}</section>
