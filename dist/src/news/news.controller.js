...
__decorate([
    (0, common_1.Get)(),
    (0, api_message_decorator_1.ApiMessage)('Actualités récupérées'),
...
__decorate([
    ...
    (0, api_message_decorator_1.ApiMessage)('Actualité récupérée'),
...
__decorate([
    ...
    (0, api_message_decorator_1.ApiMessage)('Actualité créée avec succès'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_news_dto_1.CreateActualiteDto]),
    __metadata("design:returntype", void 0)
], NewsController.prototype, "create", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Put)(':id'),
    (0, api_message_decorator_1.ApiMessage)('Actualité mise à jour'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, create_news_dto_1.UpdateActualiteDto]),
    __metadata("design:returntype", void 0)
], NewsController.prototype, "update", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Delete)(':id'),
    (0, api_message_decorator_1.ApiMessage)('Actualité supprimée'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
